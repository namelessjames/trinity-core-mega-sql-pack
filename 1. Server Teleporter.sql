...
(@ENTRY, @MODEL, @NAME, @SUBNAME, "Directions", @GOSSIP_MENU, 71, 71, 1.56, 1.56, 1.56, 35, 3, 1, 1.14286, 0.65, 1, 1, 1, 2, 7, 138936390, 2, 1, 2, "SmartAI");
...
INSERT INTO npc_text (ID, text0_0, Emote0_0) VALUES
...
INSERT INTO creature_template (entry, modelid1, name, subname, IconName, gossip_menu_id, minlevel, maxlevel, faction, npcflag, speed_walk, speed_run, scale, `rank`, unit_class, unit_flags, type, type_flags, MovementType, RegenHealth, flags_extra, AIName) VALUES
